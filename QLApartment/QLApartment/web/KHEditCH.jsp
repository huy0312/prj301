    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="KHQLCanHo.jsp">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="KHQLDichVu.jsp">Quản lí Dịch vụ</a>
                            <div class="collapse-divider"></div>
                            <h6 class="collapse-header">Căn hộ:</h6>
                            <a class="collapse-item" href=KHQLCanHo.jsp>Quản lý căn hộ</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">QUẢN LÝ CHUNG CƯ</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="CRUD" method="GET">
                                        ...
                                        %>
                                        <h3 class="mb-5">Thuê Phòng</h3>
                                        <div class="form-outline mb-4">
                                            <h6 class="m-0 font-weight-bold text-primary">Mã phòng</h6>
                                            <select name="id" class="form-control form-control-lg" readonly>
                                        ...
                                        <div class="form-outline mb-4">
                                            <select name="idKH" class="form-control form-control-lg"  id="gender">
                                                <option value="${sessionScope.cus.idKH}">${sessionScope.cus.getTenKH()}</option>
                                            </select>
                                        </div>
                                        <h6 class="m-0 font-weight-bold text-primary">Tháng thuê</h6>
                                        <div class="form-outline mb-4">
                                            <select readonly name="ThangThue" class="form-control form-control-lg"  id="Thangthue">
                                                <%
                                        ...
                                        <div class="form-outline mb-4">
                                            <input readonly name="GiaThue" type="text" id="typeEmailX-2" class="form-control form-control-lg" placeholder="Giá Thuê" value="<%=String.format("%.0f",dtoApartment.getGiaThue())%>" required pattern="^[1-9]+[0-9]*$" title="Giá Tiền phải là số dương"/>
                                        </div>
                                        ...
                                        %>
                                        <button class="btn btn-primary btn-lg btn-block" type="submit" name="type" value="ApplyEdit">Thuê Phòng</button>
                                        <button class="btn btn-primary btn-lg btn-block" type="submit" name="type" value="Cancel">Huỷ</button>
                                        <%
                                        } else {
                                        %>
                                        <h3 class="mb-5">Thêm Căn hộ</h3>
                                        <h6 class="m-0 font-weight-bold text-primary">Người thuê</h6>
                                        <div class="form-outline mb-4">
                                            <select name="idKH" class="form-control form-control-lg"  id="gender">
