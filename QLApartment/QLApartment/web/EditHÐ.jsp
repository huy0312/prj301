                                    ...
                                    <form action="CRUD" method="POST">
                                        ...
                                        <div class="form-outline mb-4">
                                            <select name="idPhong" class="form-control form-control-lg"  id="gender" onchange="myFunction(this.value)">
                                                ...
                                                %>
                                                <option id="contain-id" value="<%= dtoPT.getIdPhong()%>.<%= dtoPT.getThangThue()%>" selected><%= dtoPT.getIdPhong()%></option>
                                                <%
                                        ...
                                        <div class="form-outline mb-4">
                                            <input name="TongTien" type="number" id="TongTien" class="form-control form-control-lg" value="<%=String.format("%.0f", dtoTT.getTongTien()) %>" readonly/>
                                        </div>
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Tháng Thuê</h6>
                                        <div class="form-outline mb-4">
                                            <input name="ThangThue" type="text" id="ThangThue" class="form-control form-control-lg" readonly value="<%=listApartment.get(0).getThangThue()%>"/>
                                        </div>
