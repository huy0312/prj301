    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${sessionScope.Account.getRoleId()==2?"QLCanHo.jsp" : "KHQLCanHo.jsp"}">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="CRUD" method="GET">
                                        ...
                                        <div class="form-outline mb-4">
                                            <input name="phone" type="text" id="typeEmailX-2" class="form-control form-control-lg" placeholder="Số điện thoại" value="<%= dtoKH.getSDT()%>" required pattern="^(\+84|0(3|5|7|8|9){1})(\d){7,8}$" title="Số điện thoại không tồn tại"/>
                                        </div>
                                        <h6 class="m-0 font-weight-bold text-primary">Chứng minh nhân dân</h6>
                                        <div class="form-outline mb-4">
                                            <input name="cmnd" type="text" ${sessionScope.Account.getRoleId()==2?"readonly":""} id="typeEmailX-2" class="form-control form-control-lg" placeholder="CMND" value="<%= dtoKH.getCMND()%>" required pattern="([0-9][0-9]+[1-9])+([0-9]{9})" title="Chứng minh nhân dân không hợp lệ"/>
                                        </div>
